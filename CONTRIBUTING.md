...
- **GitHub Copilot** — [Extending Copilot Chat in your organization](https://docs.github.com/en/copilot/customizing-copilot/extending-copilot-chat-in-your-organization)
